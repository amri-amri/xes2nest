...
public class ListClassFactory extends ClassFactory{

    private AggregateClass syntaxClass;
    private final String CLASS_NAME = "XESListClass";
    ...
    private void createOrGetSyntaxClass() {
        ...
        if (syntaxClass == null) {
            ...
            syntaxClass.updateAttributeType("value",model.getListSystemClass());
