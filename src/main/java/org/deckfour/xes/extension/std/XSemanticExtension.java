...
public class XSemanticExtension extends XExtension {
	...
	private XSemanticExtension() {
		...
		XGlobalAttributeNameMap.instance().registerMapping(XGlobalAttributeNameMap.MAPPING_ENGLISH, KEY_MODELREFERENCE,
				"Ontology Model Reference");
		XGlobalAttributeNameMap.instance().registerMapping(XGlobalAttributeNameMap.MAPPING_GERMAN, KEY_MODELREFERENCE,
				"Ontologie-Modellreferenz");
		XGlobalAttributeNameMap.instance().registerMapping(XGlobalAttributeNameMap.MAPPING_FRENCH, KEY_MODELREFERENCE,
				"RÃ©fÃ©rence au ModÃ¨le Ontologique");
		XGlobalAttributeNameMap.instance().registerMapping(XGlobalAttributeNameMap.MAPPING_SPANISH, KEY_MODELREFERENCE,
				"Referencia de Modelo OntolÃ³gico");
		XGlobalAttributeNameMap.instance().registerMapping(XGlobalAttributeNameMap.MAPPING_PORTUGUESE,
				KEY_MODELREFERENCE, "ReferÃªncia de Modelo OntolÃ³gico");
	}

	/**
	 * Retrieves the list of model references which describe a log element (archive,
	 * log, trace, event, attribute).
	 * 
	 * @param target
	 *            Any log element (i.e., archive, log, trace, event, or attribute)
	 *            to be queried.
	 * @return The list of model references, as a list of strings, referred to by
	 *         this element.
	 */
	public List<String> extractModelReferences(XAttributable target) {
		XAttribute attribute = target.getAttributes().get(KEY_MODELREFERENCE);
		if (attribute == null || !(attribute instanceof XAttributeLiteral)) {
			return null;
		}
		ArrayList<String> modelReferences = new ArrayList<String>();
		XAttributeLiteral modelReferenceAttribute = (XAttributeLiteral) attribute;
	 ...
	 *            Any log element (i.e., archive, log, trace, event, or attribute)
	 *            to be queried.
	 * @return The list of model references, as a list of URIs, referred to by this
	 *         element.
	 */
	...
	/**
	 * Assigns to a log element (i.e., archive, log, trace, event, or attribute) a
	 * list of model references.
	 * 
	 * @param target
	 *            Any log element (i.e., archive, log, trace, event, or attribute)
	 *            to be assigned references to.
	 * @param modelReferences
	 *            The list of model references, as a list of strings, referred to by
	 *            this element.
	 */
	 ...
	 *            The list of model references, as a list of URIs, referred to by
	 *            this element.
	 */
